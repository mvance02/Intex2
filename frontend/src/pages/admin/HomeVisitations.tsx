    ...
    },
    {
      ...
      render: (row) => (
        <div className="flex flex-wrap gap-1">
          ...
          {row.followUpNeeded && (
            <span className="inline-flex items-center px-2 py-0.5 text-xs font-semibold bg-sky-100 text-slate-700">
              📋 Follow-up
            </span>
          )}
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          onClick={openCreate}
          className="self-start sm:self-auto px-4 py-2 bg-white border border-sky-300 text-slate-900 text-xs font-semibold uppercase tracking-[0.08em] hover:bg-sky-300 hover:text-slate-900 transition-colors"
        >
          + Add Visit
        </button>
      </div>
          ...
          <div className="flex flex-wrap gap-6">
            <label className="flex items-center gap-2 text-sm text-gray-700 cursor-pointer">
              <input
                ...
                className="h-4 w-4 rounded border-gray-300 text-slate-700 focus:ring-sky-500"
              />
