                ...
                <td className="px-4 py-3">
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-2">
                    ...
                    <button
                      ...
                      className="w-full sm:w-auto px-2.5 py-2 text-xs border border-sky-200 text-slate-700 hover:bg-sky-300 hover:text-slate-900"
                    >
                      Edit
                    </button>
                    <button
      ...
      >
        <form onSubmit={saveEdit} className="space-y-4">
          ...
          <div className="flex justify-end gap-2">
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-white border border-sky-300 text-slate-900 text-xs font-semibold uppercase tracking-[0.08em] hover:bg-sky-300 hover:text-slate-900 disabled:opacity-60"
              disabled={formLoading}
            >
