    ...
    },
    {
      ...
      render: (row) => (
        <div className="flex flex-wrap gap-1">
          ...
          {row.referralMade && (
            <span className="inline-flex items-center px-2 py-0.5 text-xs font-medium bg-sky-100 text-slate-700">
              ↗ Referral
            </span>
          )}
        </div>
      ...
      render: (row) => (
        <div className="flex gap-2">
          <button
            ...
            className="px-3 py-1 text-xs border border-sky-300 text-slate-700 hover:bg-sky-300 hover:text-slate-900 font-medium"
          >
            Edit
          </button>
          <button
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          onClick={openCreate}
          className="self-start sm:self-auto px-4 py-2 bg-white border border-sky-300 text-slate-900 text-sm font-medium hover:bg-sky-300 hover:text-slate-900 transition-colors"
        >
          + Add Session
        </button>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <select
          ...
          className="flex-1 min-w-0 border border-gray-200 px-3 py-2 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-sky-500"
        >
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          action={
            <button
              onClick={openCreate}
              className="px-4 py-2 bg-white border border-sky-300 text-slate-900 text-sm font-medium hover:bg-sky-300 hover:text-slate-900"
            >
              Add Session
            </button>
          }
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500 resize-y"
            />
          ...
          <div className="flex justify-end gap-3 pt-2 border-t border-gray-100">
            ...
            <button
              onClick={handleSave}
              disabled={saving}
              className="px-4 py-2 text-sm bg-white border border-sky-300 text-slate-900 font-medium hover:bg-sky-300 hover:text-slate-900 disabled:opacity-60 flex items-center gap-2"
            >
              {saving && (
